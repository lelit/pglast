# -*- coding: utf-8 -*-
# :Project:   pglast -- DO NOT EDIT: automatically extracted from kwlist.h @ 13.3
...
COL_NAME_KEYWORDS = {'between', 'bigint', 'bit', 'boolean', 'char', 'character', 'coalesce',
                     ...
                     'none', 'normalize', 'nullif', 'numeric', 'out', 'overlay', 'position',
...
UNRESERVED_KEYWORDS = {'abort', 'absolute', 'access', 'action', 'add', 'admin', 'after',
                       ...
                       'explain', 'expression', 'extension', 'external', 'family', 'filter',
                       'first', 'following', 'force', 'forward', 'function', 'functions',
                       'generated', 'global', 'granted', 'groups', 'handler', 'header', 'hold',
                       'hour', 'identity', 'if', 'immediate', 'immutable', 'implicit',
                       'import', 'include', 'including', 'increment', 'index', 'indexes',
                       'inherit', 'inherits', 'inline', 'input', 'insensitive', 'insert',
                       'instead', 'invoker', 'isolation', 'key', 'label', 'language', 'large',
                       'last', 'leakproof', 'level', 'listen', 'load', 'local', 'location',
                       'lock', 'locked', 'logged', 'mapping', 'match', 'materialized',
                       'maxvalue', 'method', 'minute', 'minvalue', 'mode', 'month', 'move',
                       'name', 'names', 'new', 'next', 'nfc', 'nfd', 'nfkc', 'nfkd', 'no',
                       'normalized', 'nothing', 'notify', 'nowait', 'nulls', 'object', 'of',
                       'off', 'oids', 'old', 'operator', 'option', 'options', 'ordinality',
                       'others', 'over', 'overriding', 'owned', 'owner', 'parallel', 'parser',
                       'partial', 'partition', 'passing', 'password', 'plans', 'policy',
