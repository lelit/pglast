# -*- coding: utf-8 -*-
# :Project:   pglast -- DO NOT EDIT: automatically extracted from kwlist.h @ 12-latest-0-g49ab660
...
UNRESERVED_KEYWORDS = {'abort', 'absolute', 'access', 'action', 'add', 'admin', 'after',
                       ...
                       'call', 'called', 'cascade', 'cascaded', 'catalog', 'chain',
                       ...
                       'detach', 'dictionary', 'disable', 'discard', 'document', 'domain',
                       'double', 'drop', 'each', 'enable', 'encoding', 'encrypted', 'enum',
                       'escape', 'event', 'exclude', 'excluding', 'exclusive', 'execute',
                       'explain', 'extension', 'external', 'family', 'filter', 'first',
                       'following', 'force', 'forward', 'function', 'functions', 'generated',
                       'global', 'granted', 'groups', 'handler', 'header', 'hold', 'hour',
                       'identity', 'if', 'immediate', 'immutable', 'implicit', 'import',
                       'include', 'including', 'increment', 'index', 'indexes', 'inherit',
                       'inherits', 'inline', 'input', 'insensitive', 'insert', 'instead',
                       'invoker', 'isolation', 'key', 'label', 'language', 'large', 'last',
                       'leakproof', 'level', 'listen', 'load', 'local', 'location', 'lock',
                       'locked', 'logged', 'mapping', 'match', 'materialized', 'maxvalue',
                       'method', 'minute', 'minvalue', 'mode', 'month', 'move', 'name',
                       'names', 'new', 'next', 'no', 'nothing', 'notify', 'nowait', 'nulls',
                       ...
                       'plans', 'policy', 'preceding', 'prepare', 'prepared', 'preserve',
                       'prior', 'privileges', 'procedural', 'procedure', 'procedures',
                       'program', 'publication', 'quote', 'range', 'read', 'reassign',
                       ...
                       'vacuum', 'valid', 'validate', 'validator', 'value', 'varying',
                       'version', 'view', 'views', 'volatile', 'whitespace', 'within',
