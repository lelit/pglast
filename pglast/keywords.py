# -*- coding: utf-8 -*-
# :Project:   pglast — DO NOT EDIT: automatically extracted from kwlist.h @ 18.4
...
UNRESERVED_KEYWORDS = {'abort', 'absent', 'absolute', 'access', 'action', 'add', 'admin',
                       ...
                       'encoding', 'encrypted', 'enforced', 'enum', 'error', 'escape', 'event',
                       ...
                       'validator', 'value', 'varying', 'version', 'view', 'views', 'virtual',
