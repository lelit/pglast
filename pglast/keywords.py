# -*- coding: utf-8 -*-
# :Project:   pglast — DO NOT EDIT: automatically extracted from kwlist.h @ 17.7
...
COL_NAME_KEYWORDS = {'between', 'bigint', 'bit', 'boolean', 'char', 'character', 'coalesce',
                     ...
                     'inout', 'int', 'integer', 'interval', 'json', 'json_array',
                     'json_arrayagg', 'json_exists', 'json_object', 'json_objectagg',
                     'json_query', 'json_scalar', 'json_serialize', 'json_table', 'json_value',
                     'least', 'merge_action', 'national', 'nchar', 'none', 'normalize',
                     'nullif', 'numeric', 'out', 'overlay', 'position', 'precision', 'real',
...
UNRESERVED_KEYWORDS = {'abort', 'absent', 'absolute', 'access', 'action', 'add', 'admin',
                       ...
                       'comments', 'commit', 'committed', 'compression', 'conditional',
                       ...
                       'depends', 'depth', 'detach', 'dictionary', 'disable', 'discard',
                       'document', 'domain', 'double', 'drop', 'each', 'empty', 'enable',
                       'encoding', 'encrypted', 'enum', 'error', 'escape', 'event', 'exclude',
                       'excluding', 'exclusive', 'execute', 'explain', 'expression',
                       'extension', 'external', 'family', 'filter', 'finalize', 'first',
                       'following', 'force', 'format', 'forward', 'function', 'functions',
                       'generated', 'global', 'granted', 'groups', 'handler', 'header', 'hold',
                       'hour', 'identity', 'if', 'immediate', 'immutable', 'implicit',
                       'import', 'include', 'including', 'increment', 'indent', 'index',
                       'indexes', 'inherit', 'inherits', 'inline', 'input', 'insensitive',
                       'insert', 'instead', 'invoker', 'isolation', 'keep', 'key', 'keys',
                       'label', 'language', 'large', 'last', 'leakproof', 'level', 'listen',
                       'load', 'local', 'location', 'lock', 'locked', 'logged', 'mapping',
                       'match', 'matched', 'materialized', 'maxvalue', 'merge', 'method',
                       'minute', 'minvalue', 'mode', 'month', 'move', 'name', 'names',
                       'nested', 'new', 'next', 'nfc', 'nfd', 'nfkc', 'nfkd', 'no',
                       'normalized', 'nothing', 'notify', 'nowait', 'nulls', 'object', 'of',
                       'off', 'oids', 'old', 'omit', 'operator', 'option', 'options',
                       'ordinality', 'others', 'over', 'overriding', 'owned', 'owner',
                       'parallel', 'parameter', 'parser', 'partial', 'partition', 'passing',
                       'password', 'path', 'plan', 'plans', 'policy', 'preceding', 'prepare',
                       ...
                       'stored', 'strict', 'string', 'strip', 'subscription', 'support',
                       'sysid', 'system', 'tables', 'tablespace', 'target', 'temp', 'template',
                       'temporary', 'text', 'ties', 'transaction', 'transform', 'trigger',
                       'truncate', 'trusted', 'type', 'types', 'uescape', 'unbounded',
                       'uncommitted', 'unconditional', 'unencrypted', 'unknown', 'unlisten',
                       'unlogged', 'until', 'update', 'vacuum', 'valid', 'validate',
                       'validator', 'value', 'varying', 'version', 'view', 'views', 'volatile',
                       'whitespace', 'within', 'without', 'work', 'wrapper', 'write', 'xml',
                       'year', 'yes', 'zone'}
