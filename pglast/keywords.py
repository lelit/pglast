# -*- coding: utf-8 -*-
# :Project:   pglast -- DO NOT EDIT: automatically extracted from kwlist.h @ 14.6
...
UNRESERVED_KEYWORDS = {'abort', 'absolute', 'access', 'action', 'add', 'admin', 'after',
                       ...
                       'password', 'plans', 'policy', 'preceding', 'prepare', 'prepared',
                       'preserve', 'prior', 'privileges', 'procedural', 'procedure',
                       'procedures', 'program', 'publication', 'quote', 'range', 'read',
                       'reassign', 'recheck', 'recursive', 'ref', 'referencing', 'refresh',
                       'reindex', 'relative', 'release', 'rename', 'repeatable', 'replace',
                       'replica', 'reset', 'restart', 'restrict', 'return', 'returns',
                       'revoke', 'role', 'rollback', 'rollup', 'routine', 'routines', 'rows',
                       'rule', 'savepoint', 'schema', 'schemas', 'scroll', 'search', 'second',
