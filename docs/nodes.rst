...
__ https://github.com/pganalyze/libpg_query/blob/204fbdb/src/postgres/include/nodes/nodes.h
...
.. class:: pglast.enums.nodes.AggSplit
   ...
   Corresponds to the `AggSplit enum <https://github.com/pganalyze/libpg_query/blob/204fbdb/src/postgres/include/nodes/nodes.h#L380>`__.
...
.. class:: pglast.enums.nodes.AggStrategy
   ...
   Corresponds to the `AggStrategy enum <https://github.com/pganalyze/libpg_query/blob/204fbdb/src/postgres/include/nodes/nodes.h#L358>`__.
...
.. class:: pglast.enums.nodes.CmdType
   ...
   Corresponds to the `CmdType enum <https://github.com/pganalyze/libpg_query/blob/204fbdb/src/postgres/include/nodes/nodes.h#L268>`__.
...
.. class:: pglast.enums.nodes.JoinType
   ...
   Corresponds to the `JoinType enum <https://github.com/pganalyze/libpg_query/blob/204fbdb/src/postgres/include/nodes/nodes.h#L293>`__.
...
.. class:: pglast.enums.nodes.LimitOption
   ...
   Corresponds to the `LimitOption enum <https://github.com/pganalyze/libpg_query/blob/204fbdb/src/postgres/include/nodes/nodes.h#L435>`__.
...
.. class:: pglast.enums.nodes.NodeTag
   ...
   Corresponds to the `NodeTag enum <https://github.com/pganalyze/libpg_query/blob/204fbdb/src/postgres/include/nodes/nodes.h#L26>`__.
   ...
   .. data:: T_WindowFuncRunCondition

   .. data:: T_MergeSupportFunc
   ...
   .. data:: T_JsonTablePath

   .. data:: T_JsonTablePathScan

   .. data:: T_JsonTableSiblingJoin
   ...
   .. data:: T_ReturningOption

   .. data:: T_ReturningClause
   ...
   .. data:: T_JsonTableColumn

   .. data:: T_JsonKeyValue

   .. data:: T_JsonParseExpr

   .. data:: T_JsonScalarExpr

   .. data:: T_JsonSerializeExpr
   ...
   .. data:: T_AlterReplicationSlotCmd
   ...
   .. data:: T_SupportRequestModifyInPlace
...
.. class:: pglast.enums.nodes.OnConflictAction
   ...
   Corresponds to the `OnConflictAction enum <https://github.com/pganalyze/libpg_query/blob/204fbdb/src/postgres/include/nodes/nodes.h#L422>`__.
...
.. class:: pglast.enums.nodes.SetOpCmd
   ...
   Corresponds to the `SetOpCmd enum <https://github.com/pganalyze/libpg_query/blob/204fbdb/src/postgres/include/nodes/nodes.h#L402>`__.
...
.. class:: pglast.enums.nodes.SetOpStrategy
   ...
   Corresponds to the `SetOpStrategy enum <https://github.com/pganalyze/libpg_query/blob/204fbdb/src/postgres/include/nodes/nodes.h#L410>`__.
...
.. data:: AGGSPLITOP_COMBINE
   ...
   See `here for details <https://github.com/pganalyze/libpg_query/blob/204fbdb/src/postgres/include/nodes/nodes.h#L374>`__.

.. data:: AGGSPLITOP_SKIPFINAL

   See `here for details <https://github.com/pganalyze/libpg_query/blob/204fbdb/src/postgres/include/nodes/nodes.h#L375>`__.

.. data:: AGGSPLITOP_SERIALIZE

   See `here for details <https://github.com/pganalyze/libpg_query/blob/204fbdb/src/postgres/include/nodes/nodes.h#L376>`__.

.. data:: AGGSPLITOP_DESERIALIZE

   See `here for details <https://github.com/pganalyze/libpg_query/blob/204fbdb/src/postgres/include/nodes/nodes.h#L377>`__.
