...
__ https://github.com/pganalyze/libpg_query/blob/7be1aed/src/postgres/include/nodes/nodes.h
...
.. class:: pglast.enums.nodes.AggSplit
   ...
   Corresponds to the `AggSplit enum <https://github.com/pganalyze/libpg_query/blob/7be1aed/src/postgres/include/nodes/nodes.h#L373>`__.
...
.. class:: pglast.enums.nodes.AggStrategy
   ...
   Corresponds to the `AggStrategy enum <https://github.com/pganalyze/libpg_query/blob/7be1aed/src/postgres/include/nodes/nodes.h#L351>`__.
...
.. class:: pglast.enums.nodes.CmdType
   ...
   Corresponds to the `CmdType enum <https://github.com/pganalyze/libpg_query/blob/7be1aed/src/postgres/include/nodes/nodes.h#L262>`__.
...
.. class:: pglast.enums.nodes.JoinType
   ...
   Corresponds to the `JoinType enum <https://github.com/pganalyze/libpg_query/blob/7be1aed/src/postgres/include/nodes/nodes.h#L287>`__.
...
.. class:: pglast.enums.nodes.LimitOption
   ...
   Corresponds to the `LimitOption enum <https://github.com/pganalyze/libpg_query/blob/7be1aed/src/postgres/include/nodes/nodes.h#L428>`__.
...
.. class:: pglast.enums.nodes.NodeTag
   ...
   Corresponds to the `NodeTag enum <https://github.com/pganalyze/libpg_query/blob/7be1aed/src/postgres/include/nodes/nodes.h#L26>`__.
...
.. class:: pglast.enums.nodes.OnConflictAction
   ...
   Corresponds to the `OnConflictAction enum <https://github.com/pganalyze/libpg_query/blob/7be1aed/src/postgres/include/nodes/nodes.h#L415>`__.
...
.. class:: pglast.enums.nodes.SetOpCmd
   ...
   Corresponds to the `SetOpCmd enum <https://github.com/pganalyze/libpg_query/blob/7be1aed/src/postgres/include/nodes/nodes.h#L395>`__.
...
.. class:: pglast.enums.nodes.SetOpStrategy
   ...
   Corresponds to the `SetOpStrategy enum <https://github.com/pganalyze/libpg_query/blob/7be1aed/src/postgres/include/nodes/nodes.h#L403>`__.
...
.. data:: AGGSPLITOP_COMBINE
   ...
   See `here for details <https://github.com/pganalyze/libpg_query/blob/7be1aed/src/postgres/include/nodes/nodes.h#L367>`__.

.. data:: AGGSPLITOP_SKIPFINAL

   See `here for details <https://github.com/pganalyze/libpg_query/blob/7be1aed/src/postgres/include/nodes/nodes.h#L368>`__.

.. data:: AGGSPLITOP_SERIALIZE

   See `here for details <https://github.com/pganalyze/libpg_query/blob/7be1aed/src/postgres/include/nodes/nodes.h#L369>`__.

.. data:: AGGSPLITOP_DESERIALIZE

   See `here for details <https://github.com/pganalyze/libpg_query/blob/7be1aed/src/postgres/include/nodes/nodes.h#L370>`__.
