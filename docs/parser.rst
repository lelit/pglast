...
.. function:: deparse_protobuf(buffer, pretty_print=False, indent_size=4, max_line_length=80, trailing_newline=False, commas_start_of_line=False)

   :param bytes buffer: a ``Protobuf`` buffer
   :param bool pretty_print: whether the output should be prettified or not
   :param int indent_size: when prettifying, the relative indentation
   :param int max_line_length: split certain lists of items longer that this threshold
   :param bool trailing_newline: whether to add a trailing newline or not
   :param bool commas_start_of_line: place separating commas at start of line
   :returns: str
