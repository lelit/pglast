...
ALTER TABLE t1 ALTER COLUMN c1 SET STATISTICS DEFAULT

ALTER TABLE t1 ADD CONSTRAINT c1_check CHECK (c1 > 0) NOT ENFORCED NOT VALID

ALTER TABLE t1 ADD CONSTRAINT c1_fkey FOREIGN KEY (c1) REFERENCES t2(c1) NOT ENFORCED
